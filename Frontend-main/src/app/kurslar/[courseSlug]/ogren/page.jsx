      ...
      <div className={styles.sidebar}>
        <div className={styles.courseContainer}>
          ...
          <div className={styles.courseContent}>
            <Step label="1. What is Blockchain?" />
            <Step label="2. Areas of Use" />
            <Step label="3. What is Ethereum?" />
            <Step label="4. Smart Contracts" />
            <Step label="5. Solidity Programming Language" />
          </div>
        </div>
